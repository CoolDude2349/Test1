...
if (uvEnabled) {
  importScripts("https://cdn.jsdelivr.net/gh/CoolDude2349/Test1@main/uv/uv.bundle.js");
  importScripts("https://cdn.jsdelivr.net/gh/CoolDude2349/Test1@main/uv/uv.config.js");
  importScripts(__uv$config.sw || "https://cdn.jsdelivr.net/gh/CoolDude2349/Test1@main/uv/uv.sw.js");
}
if (scramjetEnabled) {
