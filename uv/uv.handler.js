...
( () => {
    ...
    function p(o) {
        ...
        let a = new W(o,c,h)
          , {HTMLMediaElement: g, HTMLScriptElement: y, HTMLAudioElement: M, HTMLVideoElement: j, HTMLInputElement: v, HTMLEmbedElement: H, HTMLTrackElement: x, HTMLAnchorElement: L, HTMLIFrameElement: n, HTMLAreaElement: O, HTMLLinkElement: T, HTMLBaseElement: E, HTMLFormElement: $, HTMLImageElement: _, HTMLSourceElement: S} = o;
        a.nativeMethods.defineProperty(o, "__uv", {
            value: e,
            enumerable: !1
        }),
        e.meta.origin = location.origin,
        e.location = a.location.emulate(t => t === "about:srcdoc" ? new URL(t) : (t.startsWith("blob:") && (t = t.slice(5)),
        ...
        o.localStorage) {
            for (let t in o.localStorage)
                t.startsWith(i + e.location.origin + "@") && (e.localStorageObj[t.slice((i + e.location.origin + "@").length)] = o.localStorage.getItem(t));
            e.lsWrap = a.storage.emulate(a.storage.localStorage, e.localStorageObj)
        }
        if (o.sessionStorage) {
            for (let t in o.sessionStorage)
                t.startsWith(i + e.location.origin + "@") && (e.sessionStorageObj[t.slice((i + e.location.origin + "@").length)] = o.sessionStorage.getItem(t));
        ...
        a.nativeMethods.defineProperty(e.meta, "base", {
            get() {
                return o.document ? (a.node.baseURI.get.call(o.document) !== d && (d = a.node.baseURI.get.call(o.document),
                P = e.sourceUrl(d)),
                P) : e.meta.url.href
            }
        }),
        ...
        e.filterKeys = [b, e.methods.setSource, e.methods.source, e.methods.location, e.methods.function, e.methods.string, e.methods.eval, e.methods.parent, e.methods.top, i + "protocol", i + "storageObj", i + "url", i + "modifiedStyle", i + "config", i + "dispatched", "Ultraviolet", "__uvHook"],
        a.on("wrap", (t, r) => {
        ...
        a.document.on("setCookie", t => {
            ...
            e.cookie.validateCookie(r, e.meta, !0) && (u.length && (u += "; "),
            u += `${r.name}=${r.value}`),
        ...
        a.element.hookProperty([y, M, j, g, _, v, H, n, x, S], "src", {
            ...
            set: (t, r, [l]) => {
                if (new String(l).toString().trim().startsWith("blob:") && r instanceof g)
                    return a.element.setAttribute.call(r, e.attributePrefix + "-attr-src", l),
        ...
        a.attribute.on("setValue", t => {
            e.attrs.isUrl(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value),
            t.data.value = e.rewriteUrl(t.data.value)),
            e.attrs.isStyle(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value),
            t.data.value = e.rewriteCSS(t.data.value, {
                context: "declarationList"
            })),
            e.attrs.isHtml(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value),
            t.data.value = e.rewriteHtml(t.data.value, {
                ...e.meta,
                document: !0,
                injectHead: e.createHtmlInject(e.handlerScript, e.bundleScript, e.clientScript, e.configScript, u, o.location.href)
            })),
            e.attrs.isSrcset(t.data.name) && (a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value),
            t.data.value = e.html.wrapSrcset(t.data.value.toString()))
        }
        ),
        ...
        a.object.on("getOwnPropertyDescriptors", t => {
            for (let r of e.filterKeys)
                delete t.data.descriptors[r]
        }
        ),
        ...
        "CSS2Properties"in o)
            ...
            "HTMLElement"in o && a.overrideDescriptor(o.HTMLElement.prototype, "style", {
                get: (t, r) => {
                    let l = t.call(r);
