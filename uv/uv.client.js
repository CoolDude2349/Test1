...
( () => {
    ...
    ;
    var m = (s, t, r) => (r = s != null ? Qe(Ye(s)) : {},
    tt(t || !s || !s.__esModule ? K(r, "default", {
        value: s,
        enumerable: !0
    }) : r, s));
    var f = et( (ut, k) => {
        "use strict";
        var y = typeof Reflect == "object" ? Reflect : null, X = y && typeof y.apply == "function" ? y.apply : function(t, r, e) {
            return Function.prototype.apply.call(t, r, e)
        }
        , g;
        y && typeof y.ownKeys == "function" ? g = y.ownKeys : Object.getOwnPropertySymbols ? g = function(t) {
        ...
        function Y(s, t, r, e) {
            ...
            if (P(r),
            o = s._events,
            o === void 0 ? (o = s._events = Object.create(null),
            s._eventsCount = 0) : (o.newListener !== void 0 && (s.emit("newListener", t, r.listener ? r.listener : r),
            o = s._events),
            i = o[t]),
            i === void 0)
                i = o[t] = r,
                ++s._eventsCount;
            else if (typeof i == "function" ? i = o[t] = e ? [r, i] : [i, r] : e ? i.unshift(r) : i.push(r),
            n = J(s),
        ...
        function ee(s, t, r) {
            ...
            if (e === void 0)
                return [];
            var n = e[t];
            return n === void 0 ? [] : typeof n == "function" ? r ? [n.listener || n] : [n] : r ? it(n) : re(n, n.length)
        }
    ...
    var E = class extends ne.default {
        ...
        overrideParseFromString() {
            this.ctx.override(this.domProto, "parseFromString", (t, r, e) => {
                ...
                return this.emit("parseFromString", i),
        ...
        overrideQuerySelector() {
            this.ctx.override(this.docProto, "querySelector", (t, r, e) => {
                ...
                return this.emit("querySelector", o),
        ...
        overrideCreateTreeWalker() {
            this.ctx.override(this.docProto, "createTreeWalker", (t, r, e) => {
                ...
                return this.emit("createTreeWalker", l),
                l.intercepted ? l.returnValue : l.target.call(l.that, l.data.root, l.data.show, l.data.filter, l.data.expandEntityReferences)
            }
            )
        }
        overrideWrite() {
    ...
    var O = class extends se.default {
        ...
        overrideAttribute() {
            this.ctx.override(this.elemProto, "getAttribute", (t, r, e) => {
                ...
                return this.emit("getAttribute", o),
            ...
            this.ctx.override(this.elemProto, "setAttribute", (t, r, e) => {
                ...
                return this.emit("setAttribute", i),
            ...
            this.ctx.override(this.elemProto, "hasAttribute", (t, r, e) => {
                ...
                return this.emit("hasAttribute", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            ),
            this.ctx.override(this.elemProto, "removeAttribute", (t, r, e) => {
                ...
                return this.emit("removeAttribute", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            )
        }
        ...
        overrideInsertAdjacentHTML() {
            this.ctx.override(this.elemProto, "insertAdjacentHTML", (t, r, e) => {
                ...
                return this.emit("insertAdjacentHTML", i),
        ...
        overrideInsertAdjacentText() {
            this.ctx.override(this.elemProto, "insertAdjacentText", (t, r, e) => {
                ...
                return this.emit("insertAdjacentText", i),
    ...
    var M = class extends ce.default {
        ...
        overrideAppend() {
            ...
            this.ctx.override(this.nodeProto, "appendChild", (t, r, e) => {
                ...
                return this.emit("appendChild", o),
    ...
    var L = class extends he.default {
        ...
        overrideItemMethods() {
            this.ctx.override(this.attrProto, "getNamedItem", (t, r, e) => {
                ...
                return this.emit("getNamedItem", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            ),
            this.ctx.override(this.attrProto, "setNamedItem", (t, r, e) => {
                ...
                return this.emit("setNamedItem", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name, i.data.value)
            }
            ),
            this.ctx.override(this.attrProto, "removeNamedItem", (t, r, e) => {
                ...
                return this.emit("removeNamedItem", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            ),
            ...
            this.ctx.override(this.attrProto, "getNamedItemNS", (t, r, e) => {
                ...
                return this.emit("getNamedItemNS", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.namespace, i.data.localName)
            }
            ),
            this.ctx.override(this.attrProto, "setNamedItemNS", (t, r, e) => {
                ...
                return this.emit("setNamedItemNS", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            ),
            this.ctx.override(this.attrProto, "removeNamedItemNS", (t, r, e) => {
                ...
                return this.emit("removeNamedItemNS", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.namespace, i.data.localName)
            }
            )
        }
    ...
    var N = class extends fe.default {
        ...
        overrideGetPropertyNames() {
            this.ctx.override(this.Object, "getOwnPropertyNames", (t, r, e) => {
                ...
                return this.emit("getOwnPropertyNames", o),
        ...
        overrideGetOwnPropertyDescriptors() {
            this.ctx.override(this.Object, "getOwnPropertyDescriptors", (t, r, e) => {
                ...
                return this.emit("getOwnPropertyDescriptors", o),
    ...
    var R = class extends we.default {
        ...
        overrideHeaders() {
            ...
            this.ctx.override(this.headersProto, "append", (t, r, e) => {
                ...
                return this.emit("appendHeader", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name, i.data.value)
            }
            ),
            this.ctx.override(this.headersProto, "delete", (t, r, e) => {
                ...
                return this.emit("deleteHeader", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name)
            }
            ),
            !0) : !1
    ...
    var V = class extends ye.default {
        ...
        overrideSetReqHeader() {
            this.ctx.override(this.xhrProto, "setRequestHeader", (t, r, e) => {
                ...
                return this.emit("setReqHeader", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name, i.data.value)
            }
            )
        }
    ...
    var I = class extends xe.default {
        ...
        overridePushState() {
            this.ctx.override(this.historyProto, "pushState", (t, r, e) => {
                ...
                return this.emit("pushState", c),
                c.intercepted ? c.returnValue : c.target.call(c.that, c.data.state, c.data.title, c.data.url)
            }
            )
        }
        overrideReplaceState() {
            this.ctx.override(this.historyProto, "replaceState", (t, r, e) => {
                ...
                return this.emit("replaceState", c),
                c.intercepted ? c.returnValue : c.target.call(c.that, c.data.state, c.data.title, c.data.url)
            }
            )
        }
      ...
      , T = class extends Se.default {
        ...
        emulate(t, r) {
            ...
            "ancestorOrigins"in this.location && this.ctx.nativeMethods.defineProperty(e, "ancestorOrigins", {
                get() {
                    let o = [];
                    return n.window.DOMStringList && n.ctx.nativeMethods.setPrototypeOf(o, n.window.DOMStringList.prototype),
                    o
                },
                set: void 0,
                enumerable: !0
    ...
    var H = class extends Oe.default {
        ...
        overridePostMessage() {
            this.ctx.override(this.window, "postMessage", (t, r, e) => {
                ...
                return this.emit("postMessage", c),
                c.intercepted ? c.returnValue : this.ctx.worker ? c.target.call(c.that, c.data.message, c.data.transfer) : c.target.call(c.that, c.data.message, c.data.origin, c.data.transfer)
            }
            )
        }
        wrapPostMessage(t, r, e=!1) {
            return this.ctx.wrap(t, r, (n, o, i) => {
                if (this.ctx.worker ? !i.length : 2 > i)
                    return n.apply(o, i);
                let c, l, u;
                e ? ([c,u=[]] = i,
                l = null) : [c,l,u=[]] = i;
                ...
                return this.emit("postMessage", h),
                h.intercepted ? h.returnValue : e ? h.target.call(h.that, h.data.message, h.data.transfer) : h.target.call(h.that, h.data.message, h.data.origin, h.data.transfer)
            }
            )
        }
    ...
    async function W() {
        let s = (await self.clients.matchAll({
          ...
          , t = Promise.race([Promise.any(s), new Promise( (r, e) => setTimeout(e, 1e3, new TypeError("timeout")))]);
        try {
            return await t
        } catch (r) {
    ...
    function Ve(s, t) {
        ...
        return t && ct.addEventListener("message", e => {
    ...
    function lt() {
        if (U === null) {
            let s = new MessageChannel, t = new ReadableStream, r;
            try {
                v.call(s.port1, t, [t]),
                r = !0
            } catch {
                ...
                if (i.type === "fetch")
                    try {
                        ...
                        await async function(c, l, u) {
                            ...
                            h.body instanceof ReadableStream || h.body instanceof ArrayBuffer ? v.call(l, {
                                type: "fetch",
                                fetch: h
                            }, [h.body]) : v.call(l, {
                                type: "fetch",
                    ...
                    try {
                        ...
                        await async function(c, l, u) {
                            ...
                            , p => {
                                p instanceof ArrayBuffer ? v.call(c.websocket.channel, {
                                    type: "message",
                                    args: [p]
                                }, [p]) : v.call(c.websocket.channel, {
                                    type: "message",
                                    args: [p]
                                })
                            }
                            ...
                            c.websocket.channel.onmessage = p => {
                                p.data.type === "data" ? h(p.data.data) : p.data.type === "close" && w(p.data.closeCode, p.data.closeReason)
                            }
                            ,
                            v.call(l, {
                                type: "websocket"
    ...
    var q = class extends Te.default {
        ...
        overridePostMessage() {
            this.ctx.override(this.workerProto, "postMessage", (t, r, e) => {
                ...
                return this.emit("postMessage", i),
    ...
    var _ = class extends Ae.default {
        ...
        overrideObjectURL() {
            this.ctx.override(this.URL, "createObjectURL", (t, r, e) => {
                ...
                return this.emit("createObjectURL", o),
            ...
            this.ctx.override(this.URL, "revokeObjectURL", (t, r, e) => {
                ...
                return this.emit("revokeObjectURL", o),
    ...
    var B = class extends qe.default {
        ...
        overrideSetGetProperty() {
            this.ctx.override(this.cssStyleProto, "getPropertyValue", (t, r, e) => {
                ...
                return this.emit("getPropertyValue", o),
            ...
            this.ctx.override(this.cssStyleProto, "setProperty", (t, r, e) => {
                ...
                return this.emit("setProperty", i),
    ...
    var G = class extends Fe.default {
        ...
        overrideOpen() {
            this.ctx.override(this.IDBFactory.prototype, "open", (t, r, e) => {
                ...
                return this.emit("idbFactoryOpen", i),
    ...
    var $ = class extends Ge.default {
        ...
        overrideWebSocket(t) {
            this.ctx.override(this.window, "WebSocket", (r, e, n) => {
                ...
                return c.addEventListener("open", () => {
                    u(new Event("open"))
                }
                ),
                ...
                c.addEventListener("message", async h => {
                    let w = h.data;
                    typeof w == "string" || ("byteLength"in w ? l.binaryType === "blob" ? w = new Blob([w]) : Object.setPrototypeOf(w, ArrayBuffer.prototype) : "arrayBuffer"in w && l.binaryType === "arraybuffer" && (w = await w.arrayBuffer(),
            ...
            this.ctx.override(this.wsProto, "send", (r, e, n) => this.socketmap.get(e).barews.send(n[0]), !1),
            this.ctx.override(this.wsProto, "close", (r, e, n) => {
                let o = this.socketmap.get(e);
                return n[0] === void 0 && (n[0] = 1e3),
                n[1] === void 0 && (n[1] = ""),
    ...
    var x = class extends Ke.default {
        ...
        wrap(t, r, e, n=!1) {
            ...
            return n && (i.prototype = o.prototype,
        ...
        wrapDescriptor(t, r, e={}) {
            ...
            if (!n)
                return !1;
            for (let o in e)
                o in n && (o === "get" || o === "set" ? n[o] = this.wrap(n, o, e[o]) : n[o] = typeof e[o] == "function" ? e[o](n[o]) : e[o]);
            return n
        }
    }
      , Pr = x;
